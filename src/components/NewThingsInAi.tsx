const NewThingsInAi = () => {
  return (
   <div className='flex flex-col items-center justify-center'>
     <div className="flex items-center flex-col justify-center max-w-7xl sm:mr-5 p-2">
    <img 
    className="sm:w-[50%] w-screen rounded-sm"
  ...
  <div className="flex w-screen flex-col items-center justify-around max-w-7xl mt-20">
